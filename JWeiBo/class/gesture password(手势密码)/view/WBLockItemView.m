...
-(void)directFlag:(CGContextRef)ctx rect:(CGRect)rect
{
    ...
    CGFloat marginSelectedCircle = 4.0f;
    
    CGFloat w = 8.0f;
    CGFloat h = 5.0f;
    CGFloat topX = rect.origin.x + rect.size.width * 0.5;
    CGFloat topY = rect.origin.y + (rect.size.width*.5f -h - marginSelectedCircle - self.selectedRect.size.height * .5f);
...
-(void)setDirect:(WBDirectionOptions)direct{
